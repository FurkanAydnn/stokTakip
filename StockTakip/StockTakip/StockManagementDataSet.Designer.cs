...
namespace StockTakip.StockManagementDataSetTableAdapters {
    ...
    public partial class BrandsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Brands] WHERE (([ID] = @Original_ID) AND ((@IsNull_BrandName =" +
                " 1 AND [BrandName] IS NULL) OR ([BrandName] = @Original_BrandName)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Brands] ([BrandName]) VALUES (@BrandName);\r\nSELECT ID, BrandNa" +
                "me FROM Brands WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Brands] SET [BrandName] = @BrandName WHERE (([ID] = @Original_ID) A" +
                "ND ((@IsNull_BrandName = 1 AND [BrandName] IS NULL) OR ([BrandName] = @Original_" +
                "BrandName)));\r\nSELECT ID, BrandName FROM Brands WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StockTakip.Properties.Settings.Default.StockManagementConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, BrandName FROM dbo.Brands";
        ...
        public virtual int Fill(StockManagementDataSet.BrandsDataTable dataTable) {
        ...
        public virtual StockManagementDataSet.BrandsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StockManagementDataSet.BrandsDataTable dataTable = new StockManagementDataSet.BrandsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StockManagementDataSet.BrandsDataTable dataTable) {
